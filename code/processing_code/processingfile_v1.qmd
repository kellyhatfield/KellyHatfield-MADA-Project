...
raw_provider1 <- raw_provider[c("Federal.Provider.Number", "Average.Number.of.Residents.per.Day",
                   ...
                   "Total.Weighted.Health.Survey.Score", "Number.of.Citations.from.Infection.Control.Inspections")]
skim(raw_provider1)
...
raw_quality1 <- raw_quality %>% 
  select (cms_certification_number_ccn, state, HAI_039_Observed, HAI_039_Obs_Rate, HAI_039_Denominator, HAI_039_RS_Rate, COMP_PERF) 
